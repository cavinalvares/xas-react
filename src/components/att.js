...
export default class Att extends React.Component {
  ...
  componentDidMount() {
    axios.get(`https://xaviers-analytic-system.herokuapp.com/black`)
      .then(res => {
  ...
  <header className="site-navbar py-4 bg-white" role="banner">
	...
	<div class="  my-overlay" style={{backgroundImage:"url(./images/img_3.jpg)",backgroundSize:"100% 100%"}} data-aos="fade">
        <div class="container">   
	 <table border="1">
              <tbody>
              <tr>
