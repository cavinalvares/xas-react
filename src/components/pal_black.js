...
export default class Pal_black extends React.Component {
  state = {
    persons: [],
    data1:{
  ...
  componentDidMount() {
    axios.get(`https://xaviers-analytic-system.herokuapp.com/pal_black`)
      .then(res => {
 ...
 graph = (b,a,g,e) =>{
  ...
  render() {
    ...
    return (
        ...
        <div class="  overlay" style={{backgroundColor:"green"}}>
        <MDBContainer>
